...
const EditProfile = () => {
    ...
    const editProfileHandler = async () => {
        ...
        try {
            setLoading(true);
            const res = await axios.post('https://uno-il5c.onrender.com/api/v1/user/profile/edit', formData,{
                headers:{
        ...
        <div className='flex max-w-2xl mx-auto pl-10'>
            <section className='flex flex-col gap-6 w-full my-8'>
                ...
                <div >
                    ...
                    <Textarea value={input.bio} onChange={(e) => setInput({ ...input, bio: e.target.value })} name='bio' className="focus-visible:ring-transparent  bg-gray-300 text-black" />
                </div>
                <div>
                    <h1 className='font-bold mb-2'>Gender</h1>
                    <Select defaultValue={input.gender} onValueChange={selectChangeHandler}>
                        <SelectTrigger className="w-full  bg-gray-300 text-black">
                            <SelectValue />
                        </SelectTrigger>
                        <SelectContent>
                            <SelectGroup>
